...
/* =========================================================================
   TOOL 1: CSS SHADOWS & BORDER GENERATOR
========================================================================= */
...
/* =========================================================================
   TOOL 2: TEXT ANALYZER & CASE CONVERTER
========================================================================= */
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              ActionChip(
                label: const Text("Capitalize Words", style: TextStyle(fontSize: 11)),
...
/* =========================================================================
   TOOL 3: RESPONSIVE SCREEN RESIZER (WEBVIEW)
========================================================================= */
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            _deviceBtn("Mobile (375px)", 375),
            const SizedBox(width: 8),
            _deviceBtn("Tablet (768px)", 768),
            const SizedBox(width: 8),
