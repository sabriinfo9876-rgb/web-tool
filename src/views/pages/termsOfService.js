    ...
    <div class="space-y-6 max-w-4xl mx-auto animate-fadeIn text-slate-300">
      ...
      <div class="space-y-6 text-xs sm:text-sm leading-relaxed">
        <section class="space-y-2">
          ...
          <p>
            By accessing or using <strong>NEXORA AI</strong> ("the Service"), you agree to be bound by these Terms of Service. If you disagree with any part of these terms, you may not access the Service.
          </p>
        </section>
        ...
        <section class="space-y-2">
          ...
          <p>
            NEXORA AI provides client-side developer utilities, security formatters, and autonomous multi-node AI engineering tools.
          </p>
          <ul class="list-disc pl-5 space-y-1 text-slate-300">
            <li><strong>Free Plan:</strong> Includes unlimited access to 68 core developer tools, daily neural AI operations, and non-intrusive advertising.</li>
            <li><strong>Developer Pro Plan ($7.99/mo or $59/yr):</strong> Unlocks all 6 premium tools (including Automated GitHub PR Repair, ECDSA Code Sign &amp; Approve, Deep AI Refactor, Clean Code, Make Responsive), 3,000 monthly AI operations, full 10-node autonomous agent consensus, unlimited Cloud Vault storage, and an entirely ad-free experience.</li>
        ...
        <section class="space-y-2">
          ...
          <p>
            You retain 100% ownership and copyright of any source code, snippets, and project files you process, format, or refactor through NEXORA AI. We do not claim any proprietary rights over user-generated code.
          </p>
        </section>
        ...
        <section class="space-y-2">
          ...
          <p>
            The Service is provided on an "AS IS" and "AS AVAILABLE" basis. While we maintain 99.9% uptime and rigorous cryptographic security, NEXORA AI shall not be liable for indirect, incidental, or consequential damages resulting from your use of the Service.
          </p>
        </section>
      </div>
    </div>
